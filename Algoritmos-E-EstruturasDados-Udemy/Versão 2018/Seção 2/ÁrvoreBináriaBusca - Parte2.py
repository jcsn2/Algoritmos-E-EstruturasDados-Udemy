class Node:
    ...
    # Nó folha não possui filhos, e cada no so pode ter no máximo 2 filhos
	def __init__(self, label):
		self.label = label #Será a chave do nó
		self.left = None #Apontador para filho a esquerda
		self.right = None #Apontador para filho a direita
